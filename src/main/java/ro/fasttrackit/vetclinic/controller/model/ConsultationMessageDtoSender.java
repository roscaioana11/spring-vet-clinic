...
public class ConsultationMessageDtoSender {
    ...
    public String toString() {
        return "ConsultationMessageDtoSender{" +
                "dateOfScheduling=" + dateOfScheduling.toString() +
                ", dateOfConsultation=" + dateOfConsultation.toString() +
                ", petName='" + petName + '\'' +
                ", ownerNames=" + ownerNames.stream().map(owner -> owner).collect(Collectors.joining(", ")) +
                '}';
    }
}
